...
if(isset($_POST['ajouter'])){
   ...
   $pid = $_POST['id_event'];
   $pid = filter_var($id_event, FILTER_SANITIZE_STRING);
   $p_qty = $_POST['nom_event'];
   $p_qty = filter_var($nom_event, FILTER_SANITIZE_STRING);
   $cart_id = $_POST['cart_id'];
   $cart_id  = filter_var($cart_id, FILTER_SANITIZE_STRING);
  

      $insert_cart = $conn->prepare("INSERT INTO `utilisateurs`(user_id, nom_event, id_event) VALUES(?,?,?)");
      $insert_cart->execute([$user_id, $id_event, $cart_id ,$nom_event]);
