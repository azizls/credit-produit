            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <head>
    <!-- Mettez ici vos balises meta, liens CSS, et autres en-têtes nécessaires -->
    <title>Ajouter un Produit</title>
</head>
<button><a href="../tables/afficherProduit.php">Retour à la liste des produits</a></button>
<body>
    ...
    ?>
  <form action="ajoutertempproduit.php" method="POST" enctype="multipart/form-data">
        <div>
            <label for="nom_produit">Nom du produit :</label>
            <input type="text" name="nom_produit" id="nom_produit" maxlength="100" placeholder="Nom du produit" required>
        </div>

        <div>
            <label for="description">Description :</label>
            <textarea name="description" id="description" maxlength="500" placeholder="Description du produit" required></textarea>
        </div>
        ...
        <div>
            ...
            <input type="number" name="prix" id="prix" step="0.01" placeholder="Prix du produit" required>
        </div>

        <div class="form-group">
            <label for="nom_categorie">Catégorie:</label><br>
            <select name="nom_categorie" id="nom_categorie" class="form-control" required>
                <option value="" disabled selected>Sélectionnez une catégorie</option>
                <?php
                $categories = $categorieController->getAllCategories();
                foreach ($categories as $categorieItem) {
                    echo '<option value="' . $categorieItem . '">' . $categorieItem . '</option>';
                }
                ?>
            </select>
        </div>
